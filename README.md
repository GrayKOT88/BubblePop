...
**Было:** Простая игра-кликер, где игрок лопает пузыри ради очков. Код представлял собой монолитный "Спагетти-код" в одном скрипте. !(Assets/Project/Scripts/Old%20Scripts)
